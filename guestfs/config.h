...
#define BMPTOPNM "/usr/bin/bmptopnm"
...
#define DB_DUMP "/usr/bin/db_dump"

/* Name of db_load program. */
#define DB_LOAD "/usr/bin/db_load"

/* Default backend. */
#define DEFAULT_BACKEND "libvirt"
...
#define GUESTFS_DEFAULT_PATH "/usr/lib64/guestfs"
...
/* Define to 1 if you have the `aug_source' function. */
#define HAVE_AUG_SOURCE 1
...
/* Define to 1 if The Sleuth Kit library (libtsk) is available. */
/* #undef HAVE_LIBTSK */
...
/* yara library found at compile time. */
/* #undef HAVE_YARA */
...
#define PACKAGE_STRING "libguestfs 1.40.2"
...
#define PACKAGE_VERSION "1.40.2"

/* Extra version string. */
#define PACKAGE_VERSION_EXTRA ""

/* Full version string. */
#define PACKAGE_VERSION_FULL "1.40.2"

/* Major version number. */
#define PACKAGE_VERSION_MAJOR 1

/* Minor version number. */
#define PACKAGE_VERSION_MINOR 40

/* Release number. */
#define PACKAGE_VERSION_RELEASE 2

/* Name of pamcut program. */
#define PAMCUT "/usr/bin/pamcut"

/* Character that separates path elements in search paths */
#define PATH_SEPARATOR ":"

/* Name of pbmtext program. */
#define PBMTEXT "/usr/bin/pbmtext"

/* Name of pnmtopng program. */
#define PNMTOPNG "/usr/bin/pnmtopng"
...
#define SUPERMIN "/usr/bin/supermin"

/* Name of 'true' program. */
#define TOOL_TRUE "/usr/bin/true"
